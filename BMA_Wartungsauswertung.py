...
class Application(tk.Tk):
    ...
    def build_ui(self) -> None:
        ...
        ttk.Button(frame, text="Prüfliste ausfüllen und exportieren", command=self.export, style="Accent.TButton").grid(row=4, column=0, columnspan=3, sticky="ew", pady=(14, 12), ipady=5)
