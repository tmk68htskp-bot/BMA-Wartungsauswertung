...
def pruefliste_ausfuellen(
    ...
    if suffix == ".ods":
        ...
        return ods_pruefliste_ausfuellen(
            event_path, checklist_path, output_path, quarter, zeitraum_tage,
            manufacturer, esser_voralarm, checklist_version
        )
...
def result_text(result: Dict[str, object]) -> str:
    ...
    lines = [
        ...
        f"Neu in freie Felder eingetragen: {len(inserted)}",
        ...
        "Bereits ausgefüllte Melderfelder werden absichtlich nicht überschrieben.",
        "",
